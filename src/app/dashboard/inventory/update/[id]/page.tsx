...
import { getProduct } from "../../_actions/get-product-by-id";
...
import { formatDateToISO } from "../../_actions/format-dateToIso";
  ...
  const initialize = async () => {
    await getProduct(params.id)
      .then((data: TProduct) => {
        ...
        setValue("grossProfit", data.grossProfit);
        setValue("status", data.status);
        const dateAcquired = formatDateToISO(data.dateAcquired);
        const dateReleased = formatDateToISO(data.dateReleased);
        setValue("dateAcquired", dateAcquired);
        setValue("dateReleased", dateReleased);
